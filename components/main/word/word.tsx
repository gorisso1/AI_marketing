...
const Word = () =>{
    return (
        <div id="target-Pricing" className="w-full">
            <div className="flex flex-col items-center gap-6 md:flex-row md:gap-16 justify-center">
                ...
                <div className="grid grid-cols-1  items-center gap-14">
                    <div className="grid grid-cols-1 justify-center text-center">
                        <span className="bg-gradient-text  text-transparent bg-clip-text md:text-72px text-6xl animate-gradient-animation">AI Marketing.</span>
                    ...
                    <span className="w-full  bg-gradient-text   h-1 animate-gradient-animation rounded"></span>


                    <div
                        className="flex  justify-center w-220px rounded-23px gap-4  items-center mx-auto  border border-col-9E9C9C p-2  hover:bg-gradient-text hover:animate-gradient-animation hover:border-0">
